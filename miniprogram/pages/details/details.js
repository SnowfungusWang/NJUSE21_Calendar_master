...
Page({
    ...
    onLoad: function (options) {
        ...
        var thischeck = ''
        var checks = [...prevPage.data.checkPointList, ...prevPage.data.passCheckPointList]
        var num
        ...
        let item = thischeck.urgency;
        const newItems = this.data.items.map(v => {
            if (v.name == item) {
                return {
                    name: item,
                    checked: true
